...
public class TranslationServletTest extends Mockito {
  ...
  public void translate_translatesRSSFieldsCorrectly() throws JsonProcessingException {
    ...
    assertEquals("episodio generado por launchpod", rssTranslatedFeed.getChannel().getDescription().toLowerCase());

    // Test item
    for (Item item : rssTranslatedFeed.getChannel().getItem()) {
